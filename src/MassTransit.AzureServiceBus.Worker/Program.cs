                ...
                .ConfigureServices((hostContext, services) =>
                {
                    services.AddMassTransit(x =>
                    {
                        ...
                        x.UsingAzureServiceBus((context, cfg) =>
                        {
                            ...
                            cfg.ReceiveEndpoint("mes-lotes-subscriber", e =>
                            {
                            ...
                            cfg.ReceiveEndpoint("mes-lotes-dead-letter", e =>
                            {
                            ...
                            cfg.SubscriptionEndpoint<LoteSchemaCriadoEvent>("notificacao-lotes-subscriber", endpointConfig =>
                            {
